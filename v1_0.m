...
WL=[412 443 488 531 551 667 667 678 678 748 869 905 936 940]; 
...
%(春)scales=[ 0.014988 0.0098706 0.0064758 0.0040139 0.0039943 0.0011444 0.00084513 0.0015127 0.00083232 0.001052 0.00093825 0.008097 0.0090284 0.0075016];%參考hdf
%(冬)scales=[ 0.014752 0.0099554 0.0066463 0.004109 0.0041047 0.0011485 0.00084666 0.0015344 0.00084514 0.0010583 0.00093732 0.008133 0.0090655 0.0075439];
%(夏)scales=[ 0.014905 0.009903 0.0065398 0.0040476 0.004031 0.0011464 0.00084629 0.0015208 0.00083731 0.0010559 0.00093822 0.0081021 0.0090398 0.0075162];
%(秋)
    ...
    for lll=1:2030
     for ooo=1:1354
        ...
        elseif (lat(lll,ooo)==-999 ||  lon(lll,ooo)==-999) 
            ...
            ppp=ppp+1;
            if (rem(ppp,2000)==0)
                daa=sum((reshape(Lawdata(lll,ooo,:),1,14)-offset).*scales.*WL/1000); %1 pixal 總能
